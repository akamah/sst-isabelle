...
type_synonym ('q, 'a, 'b) "out" =
  "'q \<Rightarrow> 'a \<Rightarrow> 'b list"
...
fun hat1 :: "('q, 'a) trans \<Rightarrow> 'q \<Rightarrow> 'a list \<Rightarrow> 'q" where
  "hat1 t q []     = q" |
  "hat1 t q (a#as) = hat1 t (t q a) as"

fun hat2 :: "('q, 'a) trans \<Rightarrow> ('q, 'a, 'b) out \<Rightarrow> 'q \<Rightarrow> 'a list \<Rightarrow> 'b list" where
  "hat2 t outf q []     = []" |
